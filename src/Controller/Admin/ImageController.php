...
class ImageController extends AbstractController
{
     ...
     */
    public function index(ImageRepository $imageRepository,Image $image): Response
    {
        return $this->render('admin/image/index.html.twig', ['images' => $imageRepository->findAll()]);
    }

    /**
     * @Route("/{aid}/new", name="admin_image_new", methods="GET|POST")
     */
    public function new(Request $request,$aid,ImageRepository $imageRepository): Response
    {
        ...
        //if ($form->isSubmitted()) {
            ...
            return $this->redirectToRoute('admin_image_new',array('aid' => $aid));
        }
